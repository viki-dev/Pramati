...
(function () {
    ...
    function da() {
        function a() {
            ...
            for (var e = 0; e < c.length; e++) {
                var b = c[e];
                null !== b && (!0 === b.ye.call(b.Xg) ? c[e] = null : D.Sc(b.repeat) && (b.repeat = b.repeat - 1, 0 >= b.repeat && (c[e] = null)))
            }
            c = c.filter(function (a) {
                return null !== a
            });
    ...
    var ha = v.Dd(function () {
        ...
        function m(a) {
            ...
            d.font =
                a.Nc[c].replace("#SIZE#", a.hc[c].toString())
        }
        ...
        function c(a) {
            return function (c, e, f, k) {
                var r = this.ga;
                return this.O[a].call(this.O, d(c, e, r), g(c, e, r), f * r[0], k * r[3])
            }
        }
        ...
        a.prototype.arc = function (a, c, e, f, k, r) {
            var s = this.ga;
            this.O.arc(d(a, c, s), g(a, c, s), e * s[0], f, k, r)
        };
        a.prototype.arcTo = function (a, c, e, f, k) {
            var r = this.ga;
            this.O.arc(d(a, c, r), g(a, c, r), d(e, f, r), g(e, f, r), k * r[0])
        };
        a.prototype.bezierCurveTo =
            function (a, c, e, f, k, r) {
                var s = this.ga;
                this.O.bezierCurveTo(d(a, c, s), g(a, c, s), d(e, f, s), g(e, f, s), d(k, r, s), g(k, r, s))
            };
        ...
        a.prototype.quadraticCurveTo = function (a, c, e, f) {
            var k = this.ga;
            this.O.quadraticCurveTo(d(a, c, k), g(a, c, k), d(e, f, k), g(e, f, k))
        };
        a.prototype.fillText =
            function (a, c, e, f) {
                var k = this.ga;
                this.O.fillText(a, d(c, e, k), g(c, e, k), D.Sc(f) ? f * k[0] : 1E20)
            };
    ...
    var ja = function () {
        ...
        return {
            dh: function () {
                ...
                for (d = 1; 6 >= d; d++) g = 2 * d * Math.PI / 6, l.push({
                    x: 0 + 100 * Math.sin(g),
                    y: 0 + 100 * Math.cos(g)
                });
                d = {
    ...
    var ia = {
        ...
        sj: function (a, m, k, f) {
            var c, d, g, l = [],
                e = 0,
                b = m.length;
            for (g = 0; g < b; g++) c = m[g], d = m[(g + 1) % b], c = M.d(c, d), c = Math.sqrt(c), l.push(c), e += c;
            k = f * (k + 0.5 * f * e / b);
            var h, n;
            f = {};
            var e = {},
                q = {},
                p = 0;
            for (g = 0; g < b; g++) c = m[g], d = m[(g + 1) % b], h = m[(g + 2) % b], n = l[(g + 1) % b], n = Math.min(0.5, k / n), M.Aa(1 - n, d, h, e), M.Aa(n, d, h, q), p++, 0 == g && (h = Math.min(0.5, k / l[0]), M.Aa(h, c, d, f), p++, a.moveTo(f.x, f.y)), a.quadraticCurveTo(d.x, d.y, e.x, e.y),
                a.lineTo(q.x, q.y);
            return !0
        }
    };
    ...
    function ka(a) {
        ...
        this.H = function (b) {
            ...
            l = 0 !==
                d ? d : void 0;
            e = 0 !== g ? g : void 0;
            "embedded" === c.getAttribute("data-foamtree") && la.Pa("visualization already embedded in the element.");
    ...
    function oa(a) {
        ...
        this.Y = function (a, c) {
            ...
            return m(c, function () {
                for (var c = !1; !c;) var c = Math.random(),
                    ...
                    e = Math.random(),
                    k = Math.random(),
                    c = f(a.x + c * a.f, a.y + d * a.i, w.x + c * w.f, w.y + d * w.i, a.x + e * a.f, a.y + k * a.i, w.x + e * w.f, w.y + k * w.i, b)
            }, !0)
        };
        this.sc = function (a, c) {
            ...
            d = a.f / a.i;
            e = r / s;
            d < e ? (k = a.i * e, g = a.i, d = a.x - 0.5 * (k - a.f), e = a.y) : d > e ? (k = a.f, g = a.f * s / r, d = a.x, e = a.y - 0.5 * (g - a.i)) : (d = a.x, e = a.y, k = a.f, g = a.i);
            d -= k * c;
            e -= g * c;
            k *= 1 + 2 * c;
            if (f(d, e, n.x, n.y, d + k, e, n.x + r / h, n.y, b)) return m(r / h / k, D.ta, !1);
            y = !1;
            return this.d(h * (n.x - d), h * (n.y - e))
        };
        this.d = function (a, b) {
        ...
        this.update = function (a) {
            ...
            e = 1 < l ? Math.pow(a, e) : 1 - Math.pow(1 - a,
                e);
            e = (y ? e : 1) * (l - 1) + 1;
            h = c * e;
            n.x = b.x - (b.x - d.x) / e;
        ...
        Ie: function (a, m, k, f) {
            ...
            try {
                ...
                if (!ra.ji) {
                    ...
                    for (window.console.log("Element", a); null !== a.parentElement;) a = a.parentElement;
                    window.console.log("Attached to DOM", a === document.body.parentElement)
                }
                c = {
                    left: 0,
                    top: 0
    ...
    function ta(a) {
        ...
        function f(a, b, d) {
            ...
            (void 0 === d.Mb && d.Ai || "prevent" === d.Mb) && a.preventDefault();
            return d
        }
        ...
        var t, y, x, A, B = {
            ...
            C = !1,
            H = !1;
        d.addEventListener("mousedown", m(function (b) {
            if (b.target !== a) {
                var c =
                    f(b, e);
                K.x = c.x;
                ...
                t = window.setTimeout(function () {
                    100 > M.d(B, c) && (window.clearTimeout(A), f(b, l), y = !0)
                }, 400)
            }
        }));
        ...
        d.addEventListener("mouseout", m(function (a) {
            f(a, q, {
                type: "out"
            })
        }));
        d.addEventListener("wheel", m(function () {
            return function (a) {
                var b;
        ...
        d.addEventListener("contextmenu", m(function (a) {
            a.preventDefault()
        }))
    };
    var X = function () {
    ...
    var D = {
        ...
        extend: function (a) {
            D.bh(Array.prototype.slice.call(arguments, 1), function (m) {
                if (m)
                    for (var k in m) m.hasOwnProperty(k) && (a[k] = m[k])
            });
            return a
        },
        A: function (a, m) {
        ...
        B: function () {
            for (var a = 0; a < arguments.length; a++) {
                var m = arguments[a];
                if (!(D.V(m) || D.Sc(m) &&
                        isNaN(m) || D.Tc(m) && D.jf(m))) return m
            }
        },
        bg: function (a, m) {
            var k = a.indexOf(m);
    ...
    var xa = {
        jg: function (a) {
            for (var m = "", k = 0; k < a.length; k++) m += String.fromCharCode(a.charCodeAt(k) ^ 1);
            return m
        }
    };
        ...
        function m(b, c, k) {
            ...
            this.wf = function (a) {
                ...
                if (0 !== c.length) {
                    var b;
                    D.V(p) ? (p = 0, b = c[p], b.W &&
                        b.W.call(b, a, r, m)) : b = c[p];
                    for (; p < c.length;) {
                        if (b.Ya && b.Ya.call(b, a, r, m)) return !0;
                        b.Da && b.Da.call(b, a, r, m);
                        D.V(p) && (p = -1);
                        ++p < c.length && (b = c[p], b.W && b.W.call(b, a, r, m))
                    }
                }
                return !1
            }
    ...
    var $ = function () {
        var a = {
            He: function (a, k) {
                if (a.e)
                    for (var f = a.e, c = 0; c < f.length; c++) k(f[c], c)
            },
            Kc: function (m, k) {
                if (m.e)
    ...
    var M = new function () {
        ...
        this.za = function (a, f, c, d, g) {
            ...
            var n = d.y - h;
            d = e * n - c * f;
            if (!(1E-12 >= d && -1E-12 <= d) && (b = b - l, h = h - a, c = (b * n - c * h) / d, d = (b * f - e * h) / d, 0 <= d && (g || 1 >= d) && 0 <= c && 1 >= c)) return {
                x: l + e * c,
                y: a + f * c
            }
        };
        this.Ig = function (a, f, c, d) {
            ...
            d = d.y -
                c;
            var h = l * d - b * f;
            if (!(1E-12 >= h && -1E-12 <= h) && (d = ((e - g) * d - b * (c - a)) / h, 0 <= d && 1 >= d)) return {
                x: g + l * d,
                y: a + f * d
            }
        };
        this.Bc = function (a, f, c) {
            for (var d = M.k(f, {}), g = M.k(c, {}), l, e = g.x - d.x, b = g.y - d.y, h = [], g = 0; g < c.length; g++) l = c[g], h.push({
                x: l.x - e,
                y: l.y - b
            });
            c = [];
        ...
        this.q = function (a, f) {
            if (0 !== a.length) {
                ...
                c = d = a[0].x;
                g = l = a[0].y;
                for (var e = a.length; 0 < --e;) c = Math.min(c, a[e].x), d = Math.max(d, a[e].x), g = Math.min(g, a[e].y), l = Math.max(l, a[e].y);
                f.x = c;
                f.y = g;
                f.f = d - c;
                f.i = l - g;
        ...
        this.k = function (a, f) {
            for (var c = 0, d = 0, g = a.length, l = a[0], e = 0, b = 1; b <
                g - 1; b++) var h = a[b],
                n = a[b + 1],
                m = l.y + h.y + n.y,
        ...
        this.Lg = function (a, f, c) {
            ...
            var l = a.y,
                ...
                b = f.x -
                a.x;
            1E-7 < Math.abs(b) && (e = (f.y - a.y) / b, a = a.y - e * a.x, l = e * d + a, e = e * g + a);
            l > e && (d = e, e = l, l = d);
            e > c.y + c.i && (e = c.y + c.i);
            l < c.y && (l = c.y);
            return l <= e
        ...
        this.se = function (k, f, c, d, g) {
            ...
            function b(b, c, d) {
                ...
                return p < h ? (h = p, l = g.x, e = g.y, 0 !== c ? Math.abs(e - f.y) / Math.abs(c) : Math.abs(l - f.x) / Math.abs(b)) : d
            }
            d = D.B(d, 0.5);
            g = D.B(g, 0.5);
            c = D.B(c, 1);
    ...
    var za = new function () {
        ...
        this.S = function (d) {
            function f(b, c, d) {
                ...
                c = c.kb;
                g = c.length;
                for (e = 0; e < g; e++) h = c[e].kd, m[h.index] = !0, 0 > r * (h.x - k.x) + s * (h.y - k.y) + l * (h.z - k.z) && a.d(b, h);
                c = d.kb;
                g = c.length;
                for (e = 0; e < g; e++) h =
                    c[e].kd, !0 !== m[h.index] && 0 > r * (h.x - k.x) + s * (h.y - k.y) + l * (h.z - k.z) && a.d(b, h)
            }
            var l, e, b, h, n = d.length;
            ...
            if (0 < (p = function () {
                    function b(a, c, d, e) {
                        ...
                        return f * e.x + g * e.y + h * e.z > f * a.x + g * a.y + h * a.z ? new m(a, c, d) : new m(d, c, a)
                    }
                    ...
                    q.push(k, l, r, s);
                    for (e = 4; e < n; e++)
                        for (f = d[e], g = 0; 4 > g; g++) h = q[g], k = h.ma[0], l = h.Oa, 0 > l.x * (f.x - k.x) + l.y * (f.y - k.y) + l.z * (f.z - k.z) && a.d(h, f);
                    return 4
                }())) {
                for (; p < n;) {
                    b = d[p];
                    if (b.$b) {
                        ...
                        do
                            if (h.push(t), w.push(y), y = (y + 1) % 3, !1 === t.C[y].visible) {
                                do
                                    for (l = t.ma[y], t = t.C[y], e = 0; 3 > e; e++) t.ma[e] == l && (y = e); while (!1 === t.C[y].visible && (t !== r || y !== s))
                            } while (t !== r || y !== s);
                        var x = null,
                            A = null;
                        for (l = 0; l < h.length; l++) {
                            var t = h[l],
                                ...
                                T = C.y - b.y,
                                N;
                            0 < c.length ? (N = c.pop(), N.ma[0] = b, N.ma[1] = K, N.ma[2] = C, N.Oa.x = H * Q - P * T, N.Oa.y = P * F - O * Q, N.Oa.z = O * T - H * F, N.kb.length = 0, N.visible = !1, N.td = !0) :
                                N = {
                                    ma: [b, K, C],
                                    C: Array(3),
                                    Oa: {
        ...
        a.d = function (c, f) {
            var l;
            0 < k.length ? (l = k.pop(),
                l.face = c, l.kd = f, l.pc = null, l.dd = null) : l = new a(c, f);
            c.kb.push(l);
            var e = f.$b;
            null !== e && (e.dd = l);
            l.pc = e;
    ...
    var Aa = new function () {
        ...
        this.cb = function (k, f) {
            for (var c = k[0], d = c.x, g = c.y, l = c.x, e = c.y, b = k.length - 1; 0 < b; b--) c = k[b], d = Math.min(d, c.x), g = Math.min(g, c.y), l = Math.max(l, c.x), e = Math.max(e, c.y);
            if (l - d < 3 * f || e - g < 3 * f) c = void 0;
            else {
                a: {
                    c = !0;void 0 == c && (c = !1);d = [];g = k.length;
                    for (l = 0; l <= g; l++) {
                        var e = k[l % g],
                            b = k[(l + 1) % g],
                            h = k[(l + 2) % g],
                        ...
                        if (e = a(e.x - s, e.y + r, b.x - s, b.y + r, b.x - q, b.y + n, h.x - q, h.y + n))
                            if (d.push(e), h = d.length, c && 3 <= h && (e = d[h - 3], b = d[h - 2], h = d[h - 1], 0 > (b.x - e.x) * (h.y - e.y) - (h.x - e.x) * (b.y - e.y))) {
                                c = void 0;
                                break a
                            }
                    }
                    ...
                    for (c = 0; c < k.length; c++) {
                        ...
                        if (0 != d.length) {
                            ...
                            if (p) d = [];
                                ...
                                s = [];
                                for (r = 0; r < d.length; r++) q = (r + 1) % d.length, p = h[r], n = h[q], 0 <= p && s.push(d[r]), (0 < p && 0 > n || 0 > p && 0 < n) && s.push(a(d[r].x, d[r].y, d[q].x, d[q].y, g, l, e, b));
                                d = s
                            }
                        }
                        if (3 > d.length) {
    ...
    var Ba = new function () {
        function a(a) {
            for (var f = a[0].x, c = a[0].y, d = f, g = c, l = 1; l < a.length; l++) var e = a[l],
                f = Math.min(f, e.x),
                c = Math.min(c, e.y),
                d = Math.max(d, e.x),
                g = Math.max(g, e.y);
                    ...
                    if (M.d(t.ha, E.ha) > m)
                        if (t.ub && E.ub) {
                            ...
                            if (2 === I.length) {
                                ...
                                r = J[t]; - 1 === s && (s = r);
                                if (-1 !== n)
                                    for (; r != n;) n = (n + 1) % k, e.push(b[n]), f.push(null);
                                e.push(I[t], I[p]);
                                f.push(c[q][2], null);
                                n = J[p]
                            }
                        ...
                        for (h = 0; h < k; h++) {
                            ...
                            if (p = M.za(b[l], b[r], t.ha, E.ha, !1)) {
                                if (-1 !== n)
                                    for (I = n; l != I;) I = (I + 1) % k, e.push(b[I]), f.push(null);
                                e.push(p);
                                f.push(c[q][2]); - 1 === s && (s = l);
                                break
                            }
                            l = r
                        } else if (!t.ub && E.ub)
                ...
                for (b = 0; b < k.length; b++)
                    if (q = n[b], 0 !== q.length) {
                        ...
                        if (0 <= w) e(r, f,
                            ...
                            var w = [],
                                t = [];
                            for (h = 0; h < s; h++) M.d(q[h][0].ha, q[(h + 1) % s][0].ha) > m && (w.push(q[h][0].ha), t.push(q[h][2]));
                            r.o = w;
                            r.C = t
                        }
        ...
        this.zc = function (k, f) {
            var c, d, g = !1,
                l = k.length;
            for (d = 0; d < l; d++) c = k[d], null === c.o && (g = !0), c.pe = c.f;
            if (g) {
                var g = a(f),
                    e = [],
                    b, h;
                ...
                for (d = 0; d < l; d++) c = k[d], s = Math.min(Math.sqrt(c.f), 0.95 * c.uf), c.f = s * s;
                this.S(k, f);
                for (d = 0; d < l; d++) c = k[d], c.pe !== c.f && 0 < c.uc && (s = Math.min(c.uc, c.pe - c.f), c.f += s, c.uc -= s)
            }
        }
    };
    var Ca = new function () {
        ...
        this.ya = function (a, m) {
            ...
            switch (m) {
                ...
                case "topleft":
                    f = k[0];
                    var l = f.x + f.y;
                    for (g = 1; g < k.length; g++) c = k[g], d = c.x + c.y, d < l && (l = d, f = c);
                    return f;
                case "bottomright":
                    f = k[0];
                    l = f.x + f.y;
                ...
                default:
                    f = k[0];
                    d = c = M.d(a, f);
                    for (g = k.length - 1; 1 <= g; g--) l = k[g], c = M.d(a, l), c < d && (d = c, f = l);
                    return f
            }
        };
            ...
            if (f[0].C) {
                ...
                for (m = m.ic = 0; g < d;)
                    if (f = c[g++], !f.ld && f.C) {
                        ...
                        for (a = 0; a < e; a++) {
                            var b = l[a];
                            b && !0 !== b.ld && (0 === b.ic && (b.ic = f.ic + 1), c[d++] = b)
                        }
                    }
            } else
    ...
    var G = function () {
        function a(a, e, h, r, s, p, w, P) {
            ...
            t.text = h;
            c(r, s, p, y);
            if (/[\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf]/.test(h)) f(t), k(e, t, u), d(F, t, y, U, N, !0, z);
            else if (k(e, t, u), d(F, t, y, U, N, !1,
                    z), !z.la && (w && (f(t), k(e, t, u)), P || w)) P && (z.ec = !0), d(F, t, y, U, U, !0, z);
            if (z.la) {
                var L = "",
                    E = 0,
                    I = Number.MAX_VALUE,
        ...
        function d(a, b, c, d, e, f, h) {
            ...
            if (0 >= r) h.la = !1;
                ...
                do {
                    var w = (s + e) / 2,
                        t = Math.min(n.length, Math.floor((r + w * (k - 1 - 2 * l)) / (w * k))),
                        y = void 0;
                    if (0 < t) {
                        var x = 1,
                            Y = t;
                        do {
                            ...
                            if (g(a, b, Z, w, c, f && w === d && Z === t, null, null)) {
                ...
                void 0 ===
                    q ? (h.la = !1, h.fontSize = 0) : (h.la = !0, h.fontSize = q, h.mc = m, h.ec = f && w === s)
            }
        }
        ...
        function g(a, c, d, f, g, k, l, n) {
            ...
            q = g;
            for (t = 0; t < d; t++) r[2 * t] = g - f / 2, r[2 * t + 1] = g + f / 2, g += J * f, g += J * m;
            ...
            for (t = 0; t < y.length; t++) {
                ...
                if (L + R < E && y.length -
                    ...
                    if (p + 1 >= d) {
                        if (k) {
                            d = E - L - J;
                            if (d > J || R > J) d = Math.floor(g.length * d / R), 0 < d && l && l(g.substring(0, d), z);
                            l && l(h, void 0);
                            n && n(p, q, g, z, L);
                            return !0
                        }
        ...
        return {
            ...
            xe: function (b, c, d, e, f, g, h, k, l, r, s, n) {
                var p, m = 0,
                    q = 0;
                d = d.toString().trim();
                !n && l.result && d === l.rg && Math.abs(r - l.ue) / r <= s && (p = l.result, p.la && (m = g.x - l.yg, q = g.y - l.zg, s = l.jd, c.save(), c.translate(m, q), s.Ta(c), c.restore()));
                p || (s = l.jd, s.clear(), p = a(b, s, d, e, f, g, h, k), p.la && s.Ta(c), l.ue = r, l.yg = g.x, l.zg = g.y, l.result = p, l.rg = d);
                return p.la ? {
                    la: !0,
                    mc: p.mc,
                    fontSize: p.fontSize,
            ...
            return function (d, g, l, e) {
                function b(a, d, e, f, g) {
                    if (0 != a.length) {
                        ...
                        n = e;
                        q = s / g;
                        do s = r.shift(), p = s.vc, m = p / q, p = s, P = n, F = m, p.x = d + q / 2, p.y = P + F / 2, l && h(s, d, n, q, m), n += m; while (0 < r.length);
                ...
                g = g.i;
                if (0 != d.length)
                    if (1 == d.length) d[0].x = n + p / 2, d[0].y = m + g / 2, d[0].Ed = 0, l && h(d[0], n, m, p, g);
                    else {
                        d = d.slice(0);
        ...
        this.te =
            a(function (a, c, d, g, l) {
                ...
                for (var e = 1 / l, b = c < d; 0 < a.length;) {
                    ...
                    h.push(n);
                    q = m(h, q, p, r);
                    s < q && (h.pop(), g.push([n]), b ? d -= k(h) / c : c -= k(h) / d, b = c < d)
                }
                return g
            }, function (a, c) {
                return a < c
            });
        this.Xb = a(function (a, c, d, g, k) {
            function e(a) {
                if (1 < g.length) {
    ...
    function Fa(a) {
        function m(b, d) {
            ...
            var e = c(d),
                f = 0;
            if ("flattened" == a.Ua && 0 < d.length && 0 < b.R) {
        ...
        this.S = function (b) {
            var c = b.group.groups,
                e = a.ri;
            return !b.e && !b.description && c && 0 < c.length && r + c.length <= e ? (r += c.length, m(b, c), d(b), g(b), !0) : !1
        };
        this.Y = function (a) {
            function c(a) {
                var b = a.groups;
    ...
    function Ia(a) {
        function m(a, b) {
            ...
            b.opacity = 1;
            b.Ka = 1;
            b.va = 0 > c ? 1 - p.di / 100 * c : 1;
            b.wa = 0 > c ? 1 - p.ei / 100 * c : 1;
            b.fa = 0 > c ? 1 + 0.5 * c : 1
        }
        ...
        function c(c, f, k, n) {
            var m = l();
            if (0 === c.length && !m) return (new V).J().L();
            ...
            if (A.reduce(function (a, b) {
                ...
                var x = [],
                    C = {};
                A.forEach(function (a) {
                    q[a.id] && (a.U || s.push(a), a.U = !0, $.Fa(a, function (a) {
                        x.push(b(a, 1));
                        C[a.id] = !0
                    }))
                });
                0 < x.length ? ($.F(r, function (a) {
                        q[a.id] || (a.U && s.push(a), a.U = !1);
                        C[a.id] || x.push(b(a, -1))
                    }), c.push(y.D.m({}).Za(x).call(h).bb()),
                    d(q), c.push(g(m)), k && (t.sc(B, p.Qc, p.Wa, X.pa(p.gc)), t.Qb())) : (c.push(e(k)), f && $.F(r, function (a) {
                    a.U && s.push(a)
                }))
            }
    ...
    function Ja(a) {
        ...
        var l = new function () {
            ...
            this.Tb = function (k,
                ...
                l.translate(-y, -x);
                l.translate(t.q.f * c * m, t.q.i * d * m)
            };
        ...
        this.k = function () {
            ...
            var h = a.options,
                ...
                K = 0 < B ? n / B : 0,
                C = [];
            d.A() ? l.hb(h.Pi, h.Ni, h.Qi, h.Ri, h.Mi) : l.hb(h.gg, h.fg, h.hg, h.ig, h.eg);
            Ca.Ja(k, Ca.ya(k, a.options.Oi), function (d, k, n) {
                var B = "groups" === a.options.Ii ? n : k;
                C.push(f.D.m(d).call(function () {
                    this.Ab(c)
                }).fb(g ?
                    K * (s + B * w) : 0).ia({
                    duration: g ? K * t : 0,
    ...
    function Ka(a) {
        function m(a, b) {
            ...
            if (0 === c.length) return (new V).J().L();
            var f;
        ...
        function k(d, b, h) {
            ...
            return 0 < p.length ? (a.c.p("openclose:changing"), c.D.m({}).Za(p).bb().N(function () {
                l.ud(b, r, "open", function (a) {
                    return a.open
                }, {
                    indirect: h
                }, a.options.Lf, a.options.Kf)
            })) : (new V).J().L()
        }
        var f, c, d, g, l;
        a.c.j("api:initialized", function (a) {
        ...
        this.Kb = function (c, b, d) {
            ...
            for (var f = new V, l = 0; l < c.length; l++) c[l].gb = !0;
    ...
    function La(a) {
        function m(c, d) {
            ...
            f.ud(d, b, "selected", function (a) {
                return a.selected
            }, {}, a.options.Nf, a.options.Mf)
        }
        var k, f;
        a.c.j("api:initialized", function (a) {
            f = a
    ...
    function Ma(a) {
        ...
        function d(a, b, c) {
            ...
            return function (g) {
                ...
                var k = !1,
                    ...
                    q = (b || m) && l(r),
                    s = (b || m) && e(r);
                m && (m = q ? q.group : null, r = q ? q.Vb(r, f) : r, g.Mb = void 0, h = h({
                    type: a,
                    group: m,
        ...
        this.Ba = c(d("mouseup", !1,
            void 0));
        this.d = c(d("click", !0, function (a, b) {
            if (!b.xb && !b.shiftKey) {
                var c = a.Ec;
                c && (c.na ? document.location.href = xa.jg("iuuq;..b`ssnurd`sbi/bnl.gn`lusdd") : t.select({
                    e: [c],
                    Ia: !c.selected,
        ...
        this.Va = c(d("transformstart", !1, function (a, b) {
            P = 1;
            B = b.x;
            K = b.y
        }));
        var z = 1,
            L = !1;
        this.Ja = c(d("transform", !1, function (a, b) {
            var c = b.scale - 0.01;
            p.Pg(b, c / P, b.x - B, b.y - K);
            P = c;
            B = b.x;
            K = b.y;
            z = P;
        ...
        this.cb = c(d("transformend", !1, function () {
            L && 0.8 > z ? a.c.p("interaction:reset") : f();
            L = !1
        }));
        this.Pa = c(d("mousewheel", !1, function () {
            var a = D.$g(function () {
                f()
            }, 300);
            return function (c,
                d) {
                var e = n.Ij;
                1 !== e && (e = Math.pow(e, d.wd), b ? (p.Qg(d, e), a()) : p.Yb(d, e, n.wc, X.pa(n.xc)).N(f))
            }
        }()));
        this.za = c(function () {
            var b = void 0,
    ...
    function Na(a) {
        function m(a, d, f, k) {
            ...
            for (e = 1; e < a.length; e++) {
                for (var p = a[e], r = 0.95 * Math.pow(e / a.length, k), b = b + 0.3819; m < b;) m += h[q], q = (q + 1) % h.length;
        ...
        this.d = function (a, d, g) {
            if (0 < a.length) {
                g = k[g.relaxationInitializer || g.initializer || f.hj || "random"];
                if ("box" === g.Zb) {
                    var l = M.q(d, {});
                    g.Fb(a, l);
                    M.Bc(a, M.A(l), d)
    ...
    function Pa(a) {
        ...
        this.kf = function (a) {
            return a === m ? !0 : 2 * Math.sqrt(a.K.ja / (Math.PI * a.e.length)) >= Math.max(k.Ve, 5E-5)
        };
        this.yd = function (a, c) {
            for (var b = Math.pow(k.Ra, a.R), d = k.mb * b,
                    b = k.Ad * b, f = a.e, m = f.length - 1; 0 <= m; m--) {
                var p = f[m];
                g.we(p, b);
                var r = p;
    ...
    function Qa(a, m) {
        ...
        function f(a, d) {
            m.kf(a) && (a.u || (a.u = Aa.cb(a.o, n.Ad * Math.pow(n.Ra, a.R - 1)), a.u && "flattened" == n.Ua && "stab" == n.dc && l(a)), a.u && (b.Nb(a), q.d(c(a), a.u, a.group), a.M = !0, d(a)), k(a))
        }
        ...
        function d(a) {
            ...
            Ba.S(b, a.u);
            Ba.zc(b, a.u);
            return Ca.Cg(a) * Math.sqrt(h.K.ja / a.K.ja)
        }
        ...
        function e(a) {
            a !== h && 2 * Math.sqrt(a.K.ja / (Math.PI *
                a.e.length)) < Math.max(0.85 * n.Ve, m.Ag) && (a.M = !1, a.Ca = !1, a.Qa = !0, a.u = null)
        }
        var b = this,
            h, n = a.options,
            q = new Na(a),
        ...
        this.step = function (a, b, k, l) {
            function q(b) {
                ...
                if (!b.u || !b.M) return 0;
                var h;
                b.parent && b.parent.Z || b.La ? (h = d(b), l && l(b), b.La = !g(h) && !k, b.Z = !0) : h = 0;
                m.yd(b, B);
                return h
            }
        ...
        this.complete = function (a) {
            for (var b = [h]; 0 < b.length;) {
                ...
                !c.M && c.Qa && c.o && f(c, a);
                if (c.u) {
                    if (c.parent && c.parent.Z || c.La) {
                        for (var e = 1E-4 > c.K.ja, k = 0; !(g(d(c)) || e && 32 < k++););
                        c.Z = !0;
                        c.La = !1
                    }
                    m.yd(c, b)
        ...
        this.we = function (a, b) {
            if (a.M) {
                ...
                d && (a.Xd = d);
                a.u = Aa.cb(a.o, b);
                a.u && "flattened" == n.Ua && "stab" == n.dc && l(a);
                d && !a.u && (a.Z = !0);
        ...
        this.Nb = function (a) {
            ...
            a.bk = e;
            for (a = 0; a < b.length; a++) f = b[a], f.pg = f.f, f.rc = d / Math.PI * (0 < e ? f.T / e : 1 / b.length)
        }
    };
    ...
    function Ra(a, m) {
        function k(a, d) {
            if (m.kf(a)) {
                if (!a.u || a.parent && a.parent.Z) {
                    var e = l.Ad * Math.pow(l.Ra, a.R - 1);
                    a.u = M.A(c(M.q(a.o, {}), e))
                }
                a.u && (a.M = !0, d(a))
            } else a.M = !1, $.Fa(a, function (a) {
                a.u = null
            })
        }
        ...
        function f(a) {
            function c(a) {
                ...
                var d = l.cc / (1 + l.cc),
                    ...
                    f = M.q(a.u, {}),
                    g = f.i,
                    d = Math.min(Math.max(g * d, l.Ce * Math.pow(l.Ra, a.R - 1)), g * l.Be),
                    h = l.Ic;
                "bottom" == h || 0 <= h && 180 > h ? (f.i = g - d, a.u = M.A(f), f.y += g - d, f.i = d, b()) : (f.i = d, b(), f.y += d, f.i = g - d, a.u = M.A(f))
            }
            var f;
            "stab" ==
            l.dc && 0 < a.e.length && a.e[0].description ? (f = a.e.slice(1), c(a)) : f = a.e;
            l.lc && f.sort(Oa);
            "floating" == l.dc && d(f, l.Ic, function (a) {
        ...
        this.complete = function (a) {
            for (var c = [g]; 0 < c.length;) {
                ...
                d.u && ((d.parent && d.parent.Z || d.La) && f(d), m.yd(d, c))
            }
        };
    ...
    function Ta(a, m) {
        ...
        function d() {
            ...
            (function () {
                ...
                a ? ($.Kc(z, function (a) {
                    ...
                    if (a.$ && (a.opacity !== a.bd || a.Ma)) {
                        for (var b = a.Xc, c = a;
                            (c = c.parent) && c !== z;) b += c.opacity * c.sa.a * u.Yf;
        ...
        function g() {
            ...
            }!a && 0 < u.Re && 1 != u.Xa && $.F(z, function (b) {
                if (b.$ && 0 < b.ka) return a = !0, !1
            });
            "accurate" == u.ef && (a = (a = a || 0 === u.mb) || "none" != u.Cd && u.mb < u.nb / 2, !a && u.mb < u.Rc / 2 + u.Bd * u.Xe.a && $.F(z, function (b) {
        ...
        function e() {
            ...
            E = a(e, c, u.Gj, u.Ej, u.Fj);
            J = a(e, 2 * d, "always", "always", u.gh);
            I = a(e, c, "always", "always", u.fh)
        }
        ...
        a.c.j("options:changed", function (a) {
            ...
            a.dataObject || (D.ob(a, R) && e(), D.ob(a, Y) && $.F(z, function (a) {
                a.zd = -1
            }));
        ...
        var Z = [{
                ...
                be: function (a) {
                    if ((a.selected || 0 < a.opacity && !1 === a.open || !a.X) && a.ba.Na()) {
                        ...
                        if (a.aa) {
                            var c = a.aa,
                                d = u.ih;
                            0 < d ? (d = Math.min(1, d * Math.pow(1 - u.jh * d, a.mg)), ia.sj(b, c, a.parent.K.Ob / 32, d)) : ia.le(b, c)
                        }
                        a.Vd = !0
                    }
                }
                ...
                be: function (b, c) {
                    if (b.aa && (0 < b.opacity && (!1 === b.open || !0 === b.selected) || !b.X) && b.Fc && a.options.Pc && !b.na) {
                        ...
                        a.options.mh(a.Ud, d, e);
                        e.groupLabelDrawn || (b.of = !1);
            ...
            W = [new function (a) {
                ...
                d: function () {},
                ib: function (a) {
                    this.lg && (this.lg = !1, a.save(), a.setTransform(1, 0, 0, 1, 0, 0), a.drawImage(K, 0, 0, a.canvas.width, a.canvas.height, 0, 0, a.canvas.width, a.canvas.height), a.restore(), C.save(), C.setTransform(1, 0, 0, 1, 0, 0), C.clearRect(0, 0, K.width, K.height), C.restore())
                },
                wb: function (a, b, c) {
                    if (!(a.open && a.X || a.ba.Na())) {
                        var d = u.Re * a.opacity * a.ka * ("flattened" == u.Ua ? 1 - a.parent.ka : (1 - a.Lb) * a.parent.Lb) * (1.1 <=
                            u.Xa ? 1 : (u.Xa - 1) / 0.1);
                        0 < d && (C.save(), C.beginPath(), a.Tb(C), a.ba.Ta(C), C.shadowBlur = c * b.n * d, C.shadowColor = u.oh, C.fillStyle = "rgba(0, 0, 0, 1)", C.globalCompositeOperation = "source-over", C.globalAlpha = a.opacity, C.fill(), C.shadowBlur = 0, C.shadowColor = "transparent", C.globalCompositeOperation = "destination-out", C.fill(), C.restore(), this.lg = !0)
                    }
                }
            }, {
                $a: ["offsetPolygon"],
                ...
                W: function () {
                    function a(b) {
                        var d = b.sa,
                            e = b.Eb,
                            f = b.selected,
                            g = c(d.l * b.va + (e ? u.Bh : 0) + (f ? u.Sh : 0)),
                            h = c(d.s * b.wa + (e ? u.Ch : 0) +
                                (f ? u.Th : 0));
                        b = b.Qe;
                        b.h = (d.h + (e ? u.Ah : 0) + (f ? u.Rh : 0)) % 360;
                        b.s = h;
                        b.l = g;
                        return b
                    }
                    ...
                    var d = [{
                            ...
                            hd: function (b, d) {
                                var e = b.K.Ob,
                                    f = a(b),
                                    e = d.createRadialGradient(b.x, b.y, 0, b.x, b.y, e * u.sh);
                                e.addColorStop(0, S.Y((f.h + u.ph) % 360, c(f.s + u.rh), c(f.l + u.qh)));
                                e.addColorStop(1, S.Y((f.h + u.th) % 360, c(f.s + u.vh), c(f.l + u.uh)));
                                b.ba.Ta(d);
                                d.fillStyle = e
                            }
                        }, {
                            ...
                            hd: function (a, b) {
                                ...
                                d.addColorStop(0, S.Y((f + u.Wh) % 360, c(k + u.Yh), c(e + u.Xh)));
                                d.addColorStop(1, S.Y((f + u.$h) % 360, c(k + u.bi), c(e + u.ai)));
                                b.strokeStyle = d;
                                b.lineWidth = u.nb * Math.pow(u.Ra, a.R - 1)
                            }
                        }],
                ...
                wb: function (a, b) {
                    if (a.Wd && !((0 === a.opacity ||
                        ...
                        e && (e = d && a.X && a.M && a.e[0].$ ? 1 - a.e.reduce(function (a, b) {
                            return a + b.ua * b.Zd
                        }, 0) / a.e.length * (1 - u.Yf) : 1, b.globalAlpha = c * e * g, Wa(b));
                        f && (b.globalAlpha = c * (d ? u.xi : 1) * g, b.closePath(), Xa(b), b.stroke())
                    }
                }
            }, {
                $a: ["offsetPolygon"],
                ...
                wb: function (a, b, c) {
                    (0 < a.opacity && 0 < a.fa && !a.open || !a.X) && !a.ba.Na() && (a.Vc = a.ra && a.ra.la && u.n * a.ra.fontSize * a.scale *
                        c >= u.Oh, !u.De && a.description ? a.rb = a.parent.rb : "auto" === a.Hd ? (b = a.Qe, c = b.h + (b.s << 9) + (b.l << 16), a.zd !== c && (a.rb = S.Bg(b) > (0 > a.ka ? u.ci : u.Dh) ? u.Eh : u.Nh, a.zd = c)) : a.rb = a.Hd)
                }
            }, {
                $a: ["custom"],
                ...
                ib: function () {},
                wb: function (a, b) {
                    !(0 < a.opacity && 0 < a.fa && !a.open || !a.X) || a.ac.Na() || a.ba.Na() || (a.Vc || void 0 === a.ra ? (b.globalAlpha = a.fa * (a.X ? a.opacity : 1) * (a.empty() ? 1 : u.Zf), b.fillStyle = a.rb, b.strokeStyle = a.rb, a.ac.Ta(b)) :
                        k(a, b))
                }
            }, {
                $a: ["label"],
                ...
                ib: function () {},
                wb: function (a, b, c) {
                    a.of && a.Yc && (0 < a.opacity && 0 < a.fa && !a.open || !a.X) && !a.ba.Na() && a.ra && (b.fillStyle = a.rb, b.globalAlpha = a.fa * (a.X ? a.opacity : 1) * (a.empty() ? 1 : u.Zf), a.Vc ? Ya(a, b, c) : k(a, b))
                }
            }].reverse())];
        this.H = function () {
            p = ua.ii(function () {
        ...
        this.ee = function () {
            function a() {
                ...
                }, Math.max(u.Hj, 3 * m.qg.Kd, 3 * m.qg.Jd))
            }
            var b, c;
            return function (b) {
                ab(F);
        ...
        var ca = function () {
            ...
            return {
                ...
                tj: function () {
                    u.rd ? (y.style.visibility = "visible", r.style.visibility = "hidden", r.style.opacity = 0, y.style.opacity = 1) : a("hifi", u.xg, "wireframe", u.xg)
                }
            }
        }();
        ab = function (a) {
    ...
    function Ua(a) {
        function m(a) {
            return f.Mh ? (e.fontFamily = c.fontFamily, e.fontStyle = c.fontStyle, e.fontVariant = c.fontVariant, e.fontWeight = c.fontWeight, e.lineHeight = c.lineHeight, e.horizontalPadding = c.pb, e.verticalPadding = c.eb, e.maxTotalTextHeight = c.tb, e.maxFontSize = c.sb, g.Dc(f.Lh, a, e), d.fontFamily = e.fontFamily, d.fontStyle = e.fontStyle, d.fontVariant = e.fontVariant, d.fontWeight = e.fontWeight, d.lineHeight = e.lineHeight, d.pb = e.horizontalPadding, d.eb = e.verticalPadding, d.tb = e.maxTotalTextHeight, d.sb = e.maxFontSize,
                d) : c
        }
        ...
        this.d = function (a) {
            if (!a.aa) return !1;
            var c = a.group.label;
            f.Gh && !a.na && (l.labelText = c, g.Dc(f.Fh, a, l), c = l.labelText);
            a.pf = c;
            return a.Id !=
                c
        };
        this.k = function (a) {
            ...
            a.Uc.clear();
            a.ra = void 0;
            !a.aa || D.jf(c) || "flattened" == f.Ua && !a.empty() && a.M || (a.ra = G.xe(m(a), a.Uc, c, a.aa, a.q, a.K, !1, !1, a.mi, a.K.ja, f.Ph, a.Sa));
            a.Sa = !1
        };
            ...
            function a(c) {
                if (c.M && c.Ca) {
                    var k = c.e,
                        l, m;
                    if (c.Z || c.Ma || w) {
                        0 === c.R ? n(c, d.Wi * Math.PI / 180) : q(c, d.$i * Math.PI / 180);
                        for (l = k.length - 1; 0 <= l; l--) {
                            m = k[l];
                            m.Ma = !0;
                            var C = m.Db,
                                H, Q, O, P, F = m.Pe;
                            0 === c.R ? (H = f(C, p, r, "h"), Q = (y + (1 - y) * m.Oc) * f(C, p, r, "s"), O = (1 + (0 > m.ka ? t * (m.ka + 1) : t) * (1 - m.Oc)) * f(C, p, r, "l"), P = f(C, p, r, "a")) : (O =
                                c.sa, H = O.h, Q = O.s, O = h(O.l, C, d.aj, d.bj), P = c.Pe.a);
                            F.h = H;
                            F.s = Q;
                            F.l = O;
                            F.a = P;
                            H = m.sa;
                            m.na ? (H.h = 0, H.s = 0, H.l = "light" == d.Sg ? 90 : 10, H.a = 1) : (H.h = F.h, H.s = F.s, H.l = F.l, H.a = F.a);
                            w && !m.na && (e.groupColor = H, e.labelColor = "auto", g.Dc(s, m, e, function (a) {
                                a.ratio = C
                            }), m.sa = S.Ba(e.groupColor), m.sa.a = D.Q(e.groupColor, "a") ? e.groupColor.a : 1, "auto" !== e.labelColor && (m.Hd = S.Mg(e.labelColor)))
                        }
                        c.Ma = !1
                    }
    ...
    function Ga() {
        ...
        this.Hd = "auto";
        this.rb = "#000";
        this.mg = this.R = this.Ed = this.index = 0;
        this.na = !1;
        this.ja = this.uf = 0;
        this.ea = !1;
        this.aa = null;
        ...
        this.Nd = function () {
            var c = !1;
            this.scale = 1;
            for (var d = 0; d < a.length; d++) c = a[d].qf(this, m) || c, this.scale *= m.scale;
            return c
        };
        this.Tb = function (c) {
                ...
                if (!(0 >= p || 0 >= r)) {
                    var s = a.Vc ? a.ra.fontSize * a.scale * e.scale() : 0,
                        w, t = {
                            ...
                            titleBarShown: s < g.si
                        };
                    a.na ? w = xa.jg("B`ssnu!Rd`sbi!Gn`lUsdd!whrt`mh{`uhno/!Bmhbj!uid!mnfn!un!fn!un!iuuq;..b`ssnurd`sbi/bnl.gn`lusdd!gns!lnsd!edu`hmr/") : (l.Dc(g.xj, a, t, function (a) {
                        a.titleBarWidth = r;
                        a.titleBarHeight = p;
                        a.labelFontSize = s;
                        a.viewportScale = e.scale()
                    }), w = t.titleBarText);
                    w && 0 !== w.length && t.titleBarShown && (a = e.nd(a.Ub(a, {}), {}).y > d / 2, h = {
                        x: k,
                        y: a ? h : d - m + h,
                        f: r,
                        i: p
                    }, k = M.A(h), f.fillStyle = g.sg, f.fillRect(0, a ? 0 : d - m, c, m), f.fillStyle = g.tg, G.Le({
                        fontFamily: g.yj || g.Hh,
                        fontStyle: g.Zj || g.Ih,
                        fontWeight: g.ak || g.Kh,
                        fontVariant: g.$j || g.Jh,
                        sb: g.ne,
                        Zc: g.zj,
                        pb: 0,
                        eb: 0,
    ...
    function cb(a) {
        ...
        this.ui = l(function (a, c) {
            1 === b.Pb && f(a, c) && k(1)
        });
        this.Qg = l(function (a, b) {
            e.Yb(a, b) && k(1)
        });
        this.Pg = l(function (a,
            b, c, d) {
            a = 0 | e.Yb(a, b);
            (a |= f(c, d)) && k(1)
        });
        this.vi = l(function (a, g, l) {
    ...
    function db(a, m, k) {
        ...
        function g(a) {
            ...
            var d = n.options.rf,
                e = Math.min(n.options.rf, n.options.pi);
            if (a)
                for (var f = 0; f < a.length; f++) {
                    var g = a[f];
                    c(g, b(g))
        ...
        function l(a, b) {
            var c = [],
                d = e(a, b);
            d.ti && n.c.p("model:childrenAttached", $.Mc(q));
            d.fj && A.complete(function (a) {
                J.qb(a);
                c.push(a)
            });
        ...
        this.Bc = function (a) {
            return (a = x.d(a)) ? a === q ? t.reset(m.wc, X.pa(m.xc)) : t.k(a, m.Qc, m.wc, X.pa(m.xc)) : (new V).J().L()
        };
        ...
        var u = function () {
                ...
                return {
                    ...
                    jj: function (b, c, e, f) {
                        ...
                        }) ? d(!1) : (A.qc(q), n.options.de ? (d(!1), I.cg(), I.gd()) : (A.complete(J.qb), q.Ma = !0, d(!1)))
                    },
                    ni: function (a) {
                        var c = !1;
                        q.empty() || (b(), I.Gb() || (c = A.step(J.qb, !1, !1), d(a)));
                        return c
                    },
                    Dj: function () {
                        $.Fa(q, function (a) {
                        ...
                        A.qc(q);
                        n.options.de ? (I.cg(), $.Fa(q, function (a) {
                            a.empty() || J.df(a)
                        })) : ($.Fa(q, function (a) {
                            a.empty() || J.qb(q)
                        }), A.complete(J.qb), q.Ma = !0, d(!1))
                    }
                }
            }(),
            z = function () {
                function a() {
                    ...
                    var c;
                    q.empty() || (q.open = !0, q.Qa = !0, m.de ? c = I.gd() : (I.yi(), c = f()), b(), 0 < m.fe ? (B.clear(), w.d(1)) : c = pa([c, d(1)]));
                    n.options.Sf(m.bc);
                    c && (n.options.Wf(), c.N(function () {
                        B.k(function () {
                            p.d(n.options.Vf)
                        })
                    }))
                ...
                function d(a, b) {
                    return 0 === m.Ke || b ? (w.d(a), (new V).J().L()) : r.D.m({
                        opacity: w.d()
                    }).oe(2).ia({
                        duration: m.Ke,
                        G: {
                ...
                function f() {
                    ...
                    H.d(q).N(b.k);
                    c(q, function Za() {
                        this.M && this.o && (this.Z = this.Ca = !0, b.d(), H.d(this).N(b.k), b.d(), c(this, Za).N(b.k))
                    });
                    return a.L()
                }
                ...
                return {
                    reload: function () {
                        l || (q.empty() ? a() : (J.stop(), r.d(), I.stop(), l = !0, pa(0 < m.Yd ? [H.k(), R(!1)] : [d(0)]).N(function () {
                            d(0, !0);
                            l = !1;
                            a();
                            D.defer(k)
    ...
    v.Dd(function () {
        window.CarrotSearchFoamTree = function (a) {
            ...
            function k(a) {
                ...
                l && l.validate(f, b.oi);
                var g = 0;
                h && (g += d("selection", h.A), g += d("open", h.k), g += d("exposure", h.d));
                var k = {};
                D.Ga(f, function (a, b) {
            ...
            function c(a) {
                (function () {
                    ...
                    b.ah = e.descriptionGroupDistanceFromCenter;
                    ...
                    b.vj = e.showZeroWeightGroups;
                    b.Ve = e.groupMinDiameter;
                    b.ce = e.rectangleAspectRatioPreference;
                    b.hj = e.initializer || e.relaxationInitializer;
                    b.ij = e.relaxationMaxDuration;
                    b.de = e.relaxationVisible;
                    b.ag = e.relaxationQualityThreshold;
                    b.Qh = e.groupResizingBudget;
                    b.yh = e.groupGrowingDuration;
                    b.xh = e.groupGrowingDrag;
                    b.zh = e.groupGrowingEasing;
                    b.ih = e.groupBorderRadius;
                    b.mb = e.groupBorderWidth;
                    b.Ra = e.groupBorderWidthScaling;
                    b.Ad = e.groupInsetWidth;
                    b.jh = e.groupBorderRadiusCorrection;
                    b.nb = e.groupStrokeWidth;
                    b.Rc = e.groupSelectionOutlineWidth;
                    b.Uh = e.groupSelectionOutlineColor;
                    b.Bd = e.groupSelectionOutlineShadowSize;
                    b.We = e.groupSelectionOutlineShadowColor;
                    b.Rh = e.groupSelectionFillHueShift;
                    b.Th = e.groupSelectionFillSaturationShift;
                    b.Sh = e.groupSelectionFillLightnessShift;
                    b.Ye = e.groupSelectionStrokeHueShift;
                    b.$e = e.groupSelectionStrokeSaturationShift;
                    b.Ze = e.groupSelectionStrokeLightnessShift;
                    b.wh = e.groupFillType;
                    b.sh = e.groupFillGradientRadius;
                    b.ph = e.groupFillGradientCenterHueShift;
                    b.rh = e.groupFillGradientCenterSaturationShift;
                    b.qh = e.groupFillGradientCenterLightnessShift;
                    b.th = e.groupFillGradientRimHueShift;
                    b.vh = e.groupFillGradientRimSaturationShift;
                    b.uh = e.groupFillGradientRimLightnessShift;
                    ...
                    b.Zh = e.groupStrokeGradientRadius;
                    b.Vh = e.groupStrokeGradientAngle;
                    b.$h = e.groupStrokeGradientUpperHueShift;
                    b.bi = e.groupStrokeGradientUpperSaturationShift;
                    b.ai = e.groupStrokeGradientUpperLightnessShift;
                    b.Wh = e.groupStrokeGradientLowerHueShift;
                    b.Yh = e.groupStrokeGradientLowerSaturationShift;
                    b.Xh = e.groupStrokeGradientLowerLightnessShift;
                    b.Ah = e.groupHoverFillHueShift;
                    b.Ch = e.groupHoverFillSaturationShift;
                    b.Bh = e.groupHoverFillLightnessShift;
                    ...
                    b.oh = e.groupExposureShadowColor;
                    b.Re = e.groupExposureShadowSize;
                    b.Qc = e.groupExposureZoomMargin;
                    b.di = e.groupUnexposureLightnessShift;
                    b.ei = e.groupUnexposureSaturationShift;
                    b.ci =
                        e.groupUnexposureLabelColorThreshold;
                    b.Wa = e.exposeDuration;
                    b.gc = e.exposeEasing;
                    b.cd = e.openCloseDuration;
                    b.kh = va.m(e.groupColorDecorator, g);
                    b.lh = e.groupColorDecorator !== D.ta;
                    b.Fh = va.m(e.groupLabelDecorator, g);
                    b.Gh = e.groupLabelDecorator !== D.ta;
                    b.Lh = va.m(e.groupLabelLayoutDecorator, g);
                    b.Mh = e.groupLabelLayoutDecorator !== D.ta;
                    b.mh = va.m(e.groupContentDecorator, g);
                    b.Pc = e.groupContentDecorator !== D.ta;
                    b.nh = e.groupContentDecoratorTriggering;
                    b.dj = e.rainbowStartColor;
                    b.Xi = e.rainbowEndColor;
                    b.Vi = e.rainbowColorDistribution;
                    b.Wi = e.rainbowColorDistributionAngle;
                    b.$i = e.rainbowLightnessDistributionAngle;
                    b.aj = e.rainbowLightnessShift;
                    b.bj = e.rainbowLightnessShiftCenter;
                    b.cj = e.rainbowSaturationCorrection;
                    b.Zi = e.rainbowLightnessCorrection;
                    b.Yf = e.parentFillOpacity;
                    b.xi = e.parentStrokeOpacity;
                    b.Zf = e.parentLabelOpacity;
                    b.$f = e.parentOpacityBalancing;
                    b.Ph = e.groupLabelUpdateThreshold;
                    b.Hh = e.groupLabelFontFamily;
                    b.Ih = e.groupLabelFontStyle;
                    b.Jh = e.groupLabelFontVariant;
                    b.Kh = e.groupLabelFontWeight;
                    b.Oh = e.groupLabelMinFontSize;
                    b.Rj = e.groupLabelMaxFontSize;
                    b.Qj = e.groupLabelLineHeight;
                    b.Pj = e.groupLabelHorizontalPadding;
                    b.Tj = e.groupLabelVerticalPadding;
                    b.Sj = e.groupLabelMaxTotalHeight;
                    b.Eh = e.groupLabelDarkColor;
                    b.Nh = e.groupLabelLightColor;
                    b.Dh = e.groupLabelColorThreshold;
                    b.Fj = e.wireframeDrawMaxDuration;
                    b.Gj = e.wireframeLabelDrawing;
                    b.Ej = e.wireframeContentDecorationDrawing;
                    b.xg = e.wireframeToFinalFadeDuration;
                    b.Hj = e.wireframeToFinalFadeDelay;
                    b.fh = e.finalCompleteDrawMaxDuration;
                    b.gh = e.finalIncrementalDrawMaxDuration;
                    b.Me = e.finalToWireframeFadeDuration;
                    b.rd =
                        e.androidStockBrowserWorkaround;
                    b.ef = e.incrementalDraw;
                    b.ri = e.maxGroups;
                    b.qi = e.maxGroupLevelsAttached;
                    b.rf = e.maxGroupLevelsDrawn;
                    b.pi = e.maxGroupLabelLevelsDrawn;
                    b.he = e.rolloutStartPoint;
                    b.ge = e.rolloutMethod;
                    b.mj = e.rolloutEasing;
                    ...
                    b.qj = e.rolloutPolygonDrag;
                    b.rj = e.rolloutPolygonDuration;
                    b.nj = e.rolloutLabelDelay;
                    b.oj =
                        e.rolloutLabelDrag;
                    b.pj = e.rolloutLabelDuration;
                    b.lj = e.rolloutChildGroupsDrag;
                    b.kj = e.rolloutChildGroupsDelay;
                    b.Oi = e.pullbackStartPoint;
                    b.Ii = e.pullbackMethod;
                    b.Ei = e.pullbackEasing;
                    b.Wj = e.pullbackType;
                    b.Yd = e.pullbackDuration;
                    b.Ni = e.pullbackScalingStrength;
                    b.Qi = e.pullbackTranslationXStrength;
                    b.Ri = e.pullbackTranslationYStrength;
                    b.Mi = e.pullbackRotationStrength;
                    b.Pi = e.pullbackTransformationCenter;
                    b.Ji = e.pullbackPolygonDelay;
                    b.Ki = e.pullbackPolygonDrag;
                    b.Li = e.pullbackPolygonDuration;
                    b.Fi = e.pullbackLabelDelay;
                    b.Gi = e.pullbackLabelDrag;
                    b.Hi = e.pullbackLabelDuration;
                    b.Bi = e.pullbackChildGroupsDelay;
                    b.Ci = e.pullbackChildGroupsDrag;
                    b.Di = e.pullbackChildGroupsDuration;
                    b.Ke = e.fadeDuration;
                    b.eh = e.fadeEasing;
                    b.Ij = e.zoomMouseWheelFactor;
                    b.wc = e.zoomMouseWheelDuration;
                    b.xc = e.zoomMouseWheelEasing;
                    b.si = e.maxLabelSizeForTitleBar;
                    b.yj = e.titleBarFontFamily;
                    b.sg = e.titleBarBackgroundColor;
                    b.tg = e.titleBarTextColor;
                    b.zj = e.titleBarMinFontSize;
                    b.ne = e.titleBarMaxFontSize;
                    b.Aj = e.titleBarTextPaddingLeftRight;
                    b.Bj = e.titleBarTextPaddingTopBottom;
                    b.xj = e.titleBarDecorator;
                    b.Mj = e.attributionText;
                    b.Jj = e.attributionLogo;
                    b.Lj = e.attributionLogoScale;
                    b.Nj = e.attributionUrl;
                    ...
                    b.Lf = c("onGroupOpenOrCloseChanging",
                        b.Lf);
            ...
            function d(a) {
                return function () {
                    return a.apply(this, arguments).hh(g)
                }
            }
            var g = this,
                ...
                b = {};
            k(a);
            (a = e.element || document.getElementById(e.id)) || la.Pa("Element to embed FoamTree in not found.");
            e.element = a;
            var h = new db(a, b, e);
            h.H();
            var n = {
                get: function (a) {
                    return 0 === arguments.length ? D.extend({}, e) : m(arguments[0], Array.prototype.slice.call(arguments, 1))
                },
                set: k,
                on: function (a, b) {
                    f(a, function (a) {
        ...
        window.CarrotSearchFoamTree.defaults = Object.freeze({
            ...
            interactionHandler: v.hi() ? "hammerjs" : "builtin",
            onModelChanging: [],
            onModelChanged: [],
            onRedraw: [],
            onRolloutStart: [],
        ...
        window.CarrotSearchFoamTree.geometry = Object.freeze(function () {
            return {
                ...
                boundingBox: function (a) {
                    for (var m = a[0].x, k = a[0].y, f = a[0].x, c = a[0].y, d = 1; d < a.length; d++) {
                        var g = a[d];
                        g.x < m && (m = g.x);
                        g.y < k && (k = g.y);
                        g.x > f && (f = g.x);
        ...
        window.CarrotSearchFoamTree.Yj = !1
    });
})();